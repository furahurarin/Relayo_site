...
export default function CompanySection() {
  ...
  const strengths = [
    ...
    },
    {
      ...
      description:
        "診断シート→メール中心（必要に応じてビデオ）で要件を確定。打合せコストを抑えつつ、文言と決裁フローの精度を両立します。",
    },
    {
      icon: TrendingUp,
      title: "データで継続改善",
      description:
        "Umami または GA4 で可視化し、軽微な改修とA/Bテスト（プランに応じて）で“作って終わり”にしません。",
    },
  ] as const;

  return (
    <section className="bg-gray-50 py-20" aria-labelledby="company-heading">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-16 space-y-4 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-gray-600">
            ...
            <strong>オンライン（メール中心／必要に応じてビデオ）</strong>
            で完結します。
          </p>
        </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm leading-relaxed text-gray-600">
                  ...
                  ドメイン・ホスティングは原則お客様名義、当方は<strong>最小権限</strong>
                  で運用する安心設計です。
                </p>
              </div>
            </CardContent>
          ...
          <Card className="mx-auto max-w-4xl border-2 border-green-100 bg-gradient-to-r from-green-50 to-emerald-50">
            <CardContent className="p-8 text-center">
              ...
              <p className="mb-6 leading-relaxed text-gray-600">
                現状URLやKPIを共有いただければ、最短ルートの立ち上げと公開後の運用計画までまとめてご提案します。
              </p>
